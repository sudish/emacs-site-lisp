...
;; $Id: shop.el,v 1.2 1997/02/04 19:15:48 friedman Exp $
...
(defconst shop-adjectives
  '["Arab-Israeli" "Arctic" "Asiatic" "Atlantic" "Baltic" "Braille"
    ...
    "antic" "antiperspirant" "anxious" "apathetic" "apocalyptic"
    ...
    "previous" "problematic" "prodigious" "proficient" "prolific"
...
(defconst shop-nouns
  '[["Budweiser" "buds"] ["Garden Weasel"]
    ...
    ["excitement"] ["exclamation"] ["exclusion"] ["exhibition"]
    ["expectation"] ["expectorant"] ["explosion"] ["expulsion"]
    ["face" ers] ["fashion"] "fiction" ["finger"] "fission" ["flake"]
    ["flossbag"] ["flotation" "floats"] "food" "friction" "friction"
    ["frivolity" "cheater-hawks"] "fruit" "furniture" ["ghost-melt"]
    ...
    ["lozenge"] ["lunchbox" "bits"] "malnutrition" ["melon"] ["metronome"]
    ["minion"] ["miscreant"] ["mispronunciation"] "money" ["monkey"]
    ["mound"] ["mountain"] ["mouse" "mice"] ["neglect" ers]
    ...
    ["treaty" ies -1] "trout" ["turkey"] ["unit"] ["vagrant"] "vapor"
    ["warrior"] ["watch" "watchers"] ["wavechord"] ["welt"] ["whip"]
...
(defun shop-middle-name ()
  ...
  (interactive)
  (message "%s, your middle name is \"%s.\""
           (user-full-name)
