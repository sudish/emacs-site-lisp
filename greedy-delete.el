...
(defconst gd-version "1.9"
  "greedy-delete version number.")
...
(defgroup greedy-delete nil
  "Greedy (a.k.a. hungry) deletion minor mode."
  :prefix "gd-"
  :group 'programming)

(defcustom gd-how-much 'all
...
beginning of the current line."
  :type '(radio
	  (const :tag "Consume all whitespace preceding point" all)
	  (const :tag "Consume just up to the beginning of line" line))
  :group 'greedy-delete)

(defcustom gd-delete-function 'backward-delete-char-untabify
